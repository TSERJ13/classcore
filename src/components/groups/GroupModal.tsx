    ...
    return (
        <MainPortal>
            ...
            <div className={cn(
                ...
                {/* Footer */}
                <div className="px-4 py-3 sm:px-5 sm:py-4 border-t border-border-subtle space-y-2 sm:space-y-3 flex-shrink-0 bg-white/90 backdrop-blur-md sticky bottom-0 z-10 pb-safe pb-10">
