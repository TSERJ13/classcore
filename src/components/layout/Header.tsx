    ...
    return (
        <>
            ...
            <header className="sticky top-0 z-[30] min-h-[64px] md:min-h-[76px] bg-white/90 backdrop-blur-lg border-b border-border-subtle flex items-center px-4 md:px-6 py-2.5 md:py-3 transition-all duration-300 w-full flex-shrink-0 gap-3">
                ...
                <div className="relative flex-1 max-w-[320px] lg:max-w-[380px] ml-auto hidden md:block">
                ...
                <div className="flex items-center gap-0 md:gap-1.5 flex-shrink-0 ml-auto md:ml-0">
                    <button
                        ...
                        aria-label="Notes"
                    >
                        <Pin className="w-4 h-4 md:w-5 md:h-5 -rotate-45" />
                    ...
                    >
                        ...
                        {(attentionSummary?.totalCount ?? 0) > 0 && (
                            <span className="absolute -top-0.5 -right-0.5 md:top-0 md:right-0 min-w-[16px] h-4 px-1 rounded-full bg-red-500 ring-2 ring-white text-[9px] font-black text-white flex items-center justify-center shadow-xs">
