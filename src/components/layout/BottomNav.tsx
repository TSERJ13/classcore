...
export function BottomNav() {
    ...
    return (
        <nav
            className="lg:hidden fixed bottom-0 left-0 right-0 z-50 bg-[var(--sidebar-bg)] border-t border-white/[0.08] shadow-[0_-10px_40px_rgba(0,0,0,0.5)]"
            style={{ 
        ...
        >
            <div className="flex items-center justify-around md:justify-evenly w-full max-w-5xl mx-auto px-1 h-[68px]">
                {navItems.map(({ href, labelKey, icon: Icon }) => {
                    ...
                    return (
                        <Link
                            ...
                            href={href}
                            className={cn(
                                'flex flex-col items-center justify-center gap-1 px-1.5 py-1 rounded-xl transition-all duration-150 min-w-[64px] md:min-w-[100px] touch-manipulation',
                        ...
                        >
                            ...
                            <span className={cn("text-[7.5px] md:text-[11px] font-black uppercase tracking-widest truncate mt-0.5", active ? "opacity-100" : "opacity-40")}>
                                {t[labelKey]}
                            </span>
                        </Link>
                    );
