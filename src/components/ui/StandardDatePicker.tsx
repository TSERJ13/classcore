    ...
    return (
        <div className={cn("space-y-1.5 w-full", className)}>
            ...
            <div className="relative group/datepicker">
                <Calendar className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-muted group-focus-within/datepicker:text-[#6d28d9] transition-colors pointer-events-none" />
                <input
                    type="date"
                    value={value || ''}
