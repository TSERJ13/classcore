...
export const ru: Translations = {
    ...
    personalClass: 'Персональное',
    individualClass: 'Индивидуальное',
    rental: 'Аренда',
    freezeOptionsLabel: 'Периоды заморозки',
    ...
    bookLesson: 'Записать на урок',
    slotConflict: 'Это время/зал уже занято — выберите другое время.',
    pendingConfirmation: 'Записано — ожидает подтверждения преподавателя',
    startTime: 'Время начала',
    endTime: 'Время окончания',
    bookingConfirmed: 'Урок записан и подтверждён',
    vacationModeLabel: 'Режим отпуска студии',
    vacationModeDesc: 'В этот период SMS об абонементах не отправляются, а сроки продлеваются автоматически.',
    vacationStartDate: 'Дата начала',
    vacationEndDate: 'Дата окончания',
    ...
    personalSubscription: 'Персональный абонемент',
