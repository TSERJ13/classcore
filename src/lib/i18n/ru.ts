...
export const ru: Translations = {
    ...
    active: 'Активно',
    defaultPlan: 'Основной',
    setAsDefault: 'Сделать основным',
    removeDefault: 'Снять с основного',
    new: 'Новый',
    analytics: 'Аналитика',
    todayIs: 'Сегодня',
    monthOf: 'За месяц',
    ...
    calEventType: 'Тип события',
    calRecurring: 'Повторение',
    calGroupClass: 'Групповое',
    calIndividual: 'Индивидуальное',
    calRental: 'Аренда',
    calOneTime: 'Разовое',
    ...
    sa_lastSync: 'Последняя синхронизация',
    sa_studios_studiosLabel: 'Студии',
    sa_studios_studioLabel: 'Студия',
    sa_studios_planLabel: 'План',
    noDataYet: 'Данных пока нет',
    sa_studios_statusActive: 'Активна',
    sa_studios_statusBlocked: 'Заблокирована',
    sa_studios_manageBtn: 'Управление',
    sa_activity_update: 'Обновлено',
    sa_studios_discountLabel: 'скидка',
    sa_studios_limitLabel: 'Лимит:',
    sa_studios_cabinetCode: 'Код кабинета',
    sa_studios_regDate: 'Зарегистрирован:',
    navSectionBilling: 'Биллинг',
    navSectionShop: 'Магазин',
    navSectionAnalytics: 'Аналитика',
    navSectionSchedule: 'Расписание',
    navSectionNotifications: 'Уведомления',
    done: 'Готово',

    calStudent: 'Студент',
    callShort: 'Позвонить',
    dataNotFoundDesc: 'Не удалось найти профиль студента. Проверьте ссылку или свяжитесь со своей студией.',
    greeting: 'Здравствуйте',
    hallDescription: 'Управление залом',
    imageError: 'Ошибка',
    indSession: 'Индивидуальное занятие',
    phone: 'Телефон',
    saveChanges: 'Сохранить изменения',
    saved: 'Сохранено',
    saving: 'Сохранение...',
    selectHall: 'Выберите зал',
    untitledClass: 'Класс без названия',
    uploadProductPhoto: 'Загрузить фото товара',
};
