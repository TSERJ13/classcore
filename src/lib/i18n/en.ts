...
export const en: Translations = {
    ...
    active: 'Active',
    defaultPlan: 'Primary',
    removeDefault: 'Remove from primary',
    new: 'New',
    analytics: 'Analytics',
    todayIs: 'Today is',
    ...
    rental: 'Rental',
    freezeOptionsLabel: 'Freeze periods',
    ...
    slotConflict: 'That time/hall is already taken — pick another time.',
    pendingConfirmation: 'Booked — waiting for teacher confirmation',
    startTime: 'Start time',
    endTime: 'End time',
    bookingConfirmed: 'Lesson booked and confirmed',
    vacationModeLabel: 'Studio vacation mode',
    vacationModeDesc: 'During this period, subscription SMS won\'t be sent and due dates auto-extend.',
    ...
    personalSubscription: 'Personal Subscription',
    ...
    sa_studios_slugWarning: 'Changing the slug will migrate all local data and may break existing links!',
    sa_studios_cabinetCode: 'Code:',
    sa_studios_regDate: 'Registered:',
    ...
    sa_studios_studiosLabel: 'Studios',
    sa_studios_studioLabel: 'Studio',
    noDataYet: 'No data yet',
    sa_activity_update: 'Updated',
    sa_studios_discountLabel: 'off',
    sa_studios_limitLabel: 'Limit:',
    navSectionBilling: 'Billing',
    navSectionShop: 'Shop',
    navSectionAnalytics: 'Analytics',
    navSectionSchedule: 'Schedule',
    navSectionNotifications: 'Notifications',
    done: 'Done',

    calStudent: 'Student',
    callShort: 'Call',
    dataNotFoundDesc: 'We could not find your student profile. Please check the link or contact your studio.',
    greeting: 'Hello',
    hallDescription: 'Manage studio space',
    imageError: 'Error',
    indSession: 'Individual Session',
    phone: 'Phone',
