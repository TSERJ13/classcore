...
export const ka: Translations = {
    ...
    active: 'აქტიური',
    defaultPlan: 'ძირითადი',
    setAsDefault: 'მონიშნე ძირითადად',
    removeDefault: 'მოაშორე ძირითადს',
    new: 'ახალი',
    analytics: 'ანალიტიკა',
    todayIs: 'დღეს არის',
    monthOf: 'თვის ჭრილში',
    ...
    calEventType: 'ღონისძიების ტიპი',
    calRecurring: 'განმეორებადობა',
    calGroupClass: 'ჯგუფური',
    calIndividual: 'ინდივიდუალური',
    calRental: 'იჯარა',
    ...
    sa_lastSync: 'ბოლო სინქრონიზაცია',
    sa_studios_studiosLabel: 'სტუდიოები',
    sa_studios_studioLabel: 'სტუდია',
    sa_studios_planLabel: 'გეგმა',
    noDataYet: 'მონაცემები ჯერ არ არის',
    sa_studios_statusActive: 'აქტიური',
    sa_studios_statusBlocked: 'დაბლოკილი',
    sa_studios_manageBtn: 'მართვა',
    sa_activity_update: 'განახლდა',
    sa_studios_discountLabel: 'ფასდაკლება',
    sa_studios_limitLabel: 'ლიმიტი:',
    sa_studios_cabinetCode: 'კაბინეტის კოდი',
    sa_studios_regDate: 'რეგისტრირებული:',
    navSectionBilling: 'ბილინგი',
    navSectionShop: 'მაღაზია',
    navSectionAnalytics: 'ანალიტიკა',
    navSectionSchedule: 'განრიგი',
    navSectionNotifications: 'შეტყობინებები',
    done: 'დასრულდა',

    calStudent: 'მოსწავლე',
    callShort: 'დარეკვა',
    dataNotFoundDesc: 'თქვენი მოსწავლის პროფილი ვერ მოიძებნა. გთხოვთ გადაამოწმოთ ბმული ან დაუკავშირდეთ თქვენს სტუდიოს.',
    greeting: 'გამარჯობა',
    hallDescription: 'დარბაზის მართვა',
    imageError: 'შეცდომა',
    indSession: 'ინდივიდუალური გაკვეთილი',
    phone: 'ტელეფონი',
    saveChanges: 'ცვლილებების შენახვა',
    saved: 'შენახულია',
    saving: 'ინახება...',
    selectHall: 'აირჩიეთ დარბაზი',
    untitledClass: 'უსახელო კლასი',
    uploadProductPhoto: 'პროდუქტის ფოტოს ატვირთვა',
};
