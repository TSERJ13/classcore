...
export const ka: Translations = {
    ...
    groupClass: 'ჯგუფური',
    personalClass: 'პერსონალური',
    individualClass: 'ინდივიდუალური',
    rental: 'იჯარა',
    freezeOptionsLabel: 'გაყინვის პერიოდები',
    ...
    slotConflict: 'ეს დრო/დარბაზი დაკავებულია — აირჩიეთ სხვა დრო.',
    pendingConfirmation: 'დაჯავშნილია — ელოდება მასწავლებლის დადასტურებას',
    startTime: 'დაწყების დრო',
    endTime: 'დასრულების დრო',
    bookingConfirmed: 'გაკვეთილი დაჯავშნილია და დადასტურებული',
    vacationModeLabel: 'სტუდიის შვებულების რეჟიმი',
    vacationModeDesc: 'ამ პერიოდში აბონემენტების SMS არ გაიგზავნება და ვადები ავტომატურად გაიწელება.',
    vacationStartDate: 'დაწყების თარიღი',
    vacationEndDate: 'დასრულების თარიღი',
    ...
    personalSubscription: 'პერსონალური აბონემენტი',
