                ...
                <div className="grid grid-cols-3 gap-1.5 sm:gap-4">
                    {[
                        ...
                        <Link key={l.href} href={l.href}
                            className="flex flex-col items-center text-center gap-1.5 sm:gap-3 px-1 py-3 sm:p-6 rounded-xl sm:rounded-3xl bg-surface/50 border border-border-subtle hover:border-violet-500/30 hover:bg-card hover:shadow-2xl hover:shadow-black/5 transition-all duration-300 touch-manipulation group">
