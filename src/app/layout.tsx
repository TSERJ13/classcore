...
export default function RootLayout({ children }: { children: ReactNode }) {
    ...
    return (
        <html lang={activeLang} suppressHydrationWarning style={{ backgroundColor: '#f8f7f4' }}>
            <head>
            ...
            <body 
                className="min-h-screen bg-base antialiased font-sans transition-colors duration-500 overflow-x-hidden"
                style={{ backgroundColor: '#f8f7f4', margin: 0, padding: 0 }}
            >
                <LeavesBackground />
                <CacheBuster />
                            ...
                            <StudioProvider>
                                ...
                                <div className="fixed bottom-4 left-0 right-0 flex flex-col items-center justify-center gap-1.5 pointer-events-none z-50">
                                    <div className="flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/10 backdrop-blur-md border border-white/10 shadow-xl scale-90">
                                        ...
                                        <span className="text-[8px] font-black tracking-[0.3em] text-white/50 uppercase">System Integrity: Scorched Earth v2.2.1</span>
                                    </div>
                                </div>
                            </StudioProvider>
                        </GlobalErrorBoundary>
